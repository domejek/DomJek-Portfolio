  ...
  return (
    <section id="timeline" className="py-20 md:py-24">
      <div className="container" ref={ref}>
        ...
        <div className="relative border-l-2 border-primary/20 pl-8 md:pl-12">
          {timeline.map((entry) => (
            <div key={`${entry.date}-${entry.title}`} className="relative mb-10 last:mb-0">
              ...
              <div className="animate-on-scroll group relative overflow-hidden rounded-lg border border-slate-200 bg-white p-6 shadow-sm-custom transition-shadow hover:shadow-md-custom md:p-7">
                <div className="absolute inset-x-0 top-0 h-[3px] bg-primary opacity-0 transition-opacity group-hover:opacity-100" />
                <div className="mb-1 text-sm font-semibold text-primary">{entry.date}</div>
