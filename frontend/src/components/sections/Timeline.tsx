  ...
  return (
    <section id="timeline" className="py-20 md:py-24">
      <div className="container" ref={ref}>
        <SectionTitle title="Werdegang" subtitle="Meine berufliche Entwicklung und Meilensteine" />
        <div className="relative border-l-2 border-primary-light/20 pl-8 md:pl-12">
          {timeline.map((entry) => (
            <div key={`${entry.date}-${entry.title}`} className="relative mb-10 last:mb-0">
              <div className="absolute top-1 -left-[37px] h-4 w-4 rounded-full border-[3px] border-primary-light bg-white md:-left-[49px]" />
              <div className="animate-on-scroll rounded-2xl border border-black/5 bg-white p-6 shadow-sm transition-all duration-300 hover:shadow-md md:p-7">
