      ...
      <div className="container" ref={ref}>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          {quickFacts.map((fact) => (
            <div
              key={fact.label}
              className="animate-on-scroll rounded-lg border border-slate-200 bg-white p-8 text-center shadow-sm-custom"
            >
              ...
              <div className="mb-1 font-serif text-2xl font-semibold text-navy">{fact.value}</div>
