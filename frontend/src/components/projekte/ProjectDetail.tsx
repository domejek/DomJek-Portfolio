  ...
  if (!project) {
    return (
      <div className="container py-20 text-center">
        <h1 className="mb-4 text-3xl font-bold text-navy">Projekt nicht gefunden</h1>
    ...
    <div>
      <section className="bg-light py-12">
        <div className="container mx-auto max-w-[720px]">
          ...
          <h1 className="mb-4 text-3xl font-extrabold text-navy md:text-4xl">{project.name}</h1>
